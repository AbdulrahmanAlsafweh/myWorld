...
<?php
    ...
    <div class="container d-flex align-items-center justify-content-center flex-wrap loginContainer" style="width:20rem ;margin-top:29vh;border:solid 3px #eee; padding:3vh">
      <h2 class="  text-capitalize">login</h1>  
    <form action="loginAuth.php" method="POST">
          ...
          <div class="input-group mb-3">
            <span class="input-group-text" id="inputGroup-sizing-default-1">Password</span>
          ...
          <button type="submit" name="submit" class="btn btn-primary " style="margin-bottom: 9px;">Login</button>
        </form>
        <hr>
      ...
      <hr>
<p class="text-center" style="display: inline-flex; align-items: center;">Don't have an account?&nbsp;<a href="register.php">Register Now</a></p>
<hr>
